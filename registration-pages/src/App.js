  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div style={{marginBottom:'30px'}}>
        <label htmlFor="description">Breif Description:</label>
      ...
      <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
        <div style={{ marginRight: '50px' }}>
          <label htmlFor="occupationArea"> Your Occupation Area: </label>
      ...
      <button type="submit"  style={{ marginTop: '30px', marginLeft: 'auto', display: 'block', width: '150px', height: '40px', backgroundColor: '#62cdbf' }}>Save & Continue</button>
    </form>
  );
}
