class MessageParser {
    ...
    parse(message) {
      ...
      if (message.includes("serivces") || message.includes("developer")) {
      ...
      if (message.includes("freelace") || message.includes("freelancer")) {
        return this.actionProvider.handlefreelace();
      }
