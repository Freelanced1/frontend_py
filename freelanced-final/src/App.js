...
import BHomepage from './pages/RecruiterHomepage';
// import UpdateProject from './pages/buyer_update';
// import DeleteProject from './pages/buyer_delete';
// import AllProjects from './pages/all_project';
import BSearch from './pages/buyer_search';
import GoogleOneTapLogin from './pages/GoogleOneTapLogin';
import FAQs from './pages/faq';
import FOrders from './pages/FOrders';
...
return (
	...
	<Routes>
        ...
        <Route path="/freelancer_homepage" Component={FHomePage} />
		<Route path='/freelancer_navpage' element={<FHomePage  />} />
		<Route path='/freelancer_profile' element={<FProfile/>}/>
		<Route path="/RecruiterHomepage" Component={BHomepage} />
		<Route path='/buyer_profile' element={<BProfile/>}/>
		<Route path='/freelancer_search' element={<FSearch/>}/>
		<Route path='/FOrders' element={<FOrders/>}/>
