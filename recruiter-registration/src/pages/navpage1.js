...
function RegistrationForm() {  
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <button type="submit" onClick={() => navigate("/navpage2")} style={{ marginTop: '100px', marginLeft: 'auto', display: 'block', width: '150px', height: '40px', backgroundColor: '#62cdbf' }}>Save & Continue</button>
    </form>
  );
}
